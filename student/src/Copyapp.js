import image_1 from "./images/download (2).jpg";
import image_2 from "./images/download (3).jpg";
import image_3 from "./images/download (6).jpg";
import image_4 from "./images/download (9).jpg";
...
const data = [
  {
    ...
    age: 12,
    image: image_1,
    word:"o make a type specimen book. It has survived not only five centuries, but also the leap into electronic typesetting, rema",
    phone_number: "090922933"
  },
  {
    name: "Bukky",
    age: 34,
    image: image_2,
    word:"o make a type specimen book. It has survived not only five centuries, but also the leap into electronic typesetting, rempassker including versions of Lorem ",
    phone_number: "0903922322"
  },

  {
    name: "olelekn",
    age: 22,
    word:"o make a type specimen book. It has survived not only five centuries, but also the leap into electronic typesetting, remam p recently with desktop publishing software like Aldus PageMaker including versions of Lorem ",
    image: image_3,
    phone_number: "0903922332"
  },
...

  {
    ...
    age: 12,
    image: image_4,
    word:"o make a tyIpsum passages, and more recently with desktop publishing software like Aldus PageMaker including versions of Lorem ",
    phone_number: "090223739272"
  },

  {
    name: "goodness",
    age: 12,
    word:"o make a type specimen book. It has survived not only five centuries, but also the leap into electronic typesetting, remaining ",
    image: image_4,
    phone_number: "090223739272"
  }
]
...
//   return (
//     <div className="m-4">
//       <h1 className="fw-bold text-center">STUDENT INFOMATION SYSTEM</h1>
//       <div className="d-flex justify-content-space-between flex-wrap">
//         <Students image={data[0].image} name={data[0].name} words={data[0].word } />
//         <Students image={data[1].image} name={data[1].name} words={data[2].word} />
        
//         <Students image={data[2].image} name={data[2].name} words={data[3].word }/>
//       </div>
//     </div>
//   );
// }
...
//   // onsubmit
//   // useState
//   const [data, setData] = useState();//storing, strig,object, array, boolean,numbers
...
//   const handleEmail =(e)=>{
//     setEmail(e.target.value)//updating the usermail
//     console.log(e.target.value)
//   }
//   const handleAge =(e)=>{
//     setAge(e.target.value)//updating the age
//     console.log(e.target.value)
//   }
//   const handleUser =(e)=>{
//     setUserName(e.target.value)//updating the username
//     console.log(e.target.value)
//   }

//   const handleSubmit = (e)=>{
//     e.preventDefault();
//     database.push(username,email,age)
...
//     <input placeholder="Username" onChange={handleUser} value={username}/>
//       <input placeholder="mail" onChange={handleEmail} value={email} />
//       <input placeholder="age" onChange={handleAge} value={age} />
//       <button id="" className="" onClick={sayName}>Click Me!!!</button>
//       </form> */}
//     </div>
...
//         <img src={props.image} class="card-img-top" alt="..." height="300" />
//         <hr/>
//         <div class="card-body">
//           <h5 class="card-title">{props.name}</h5>
//           <hr></hr>
//           <p class="card-text">{props.words }</p>
